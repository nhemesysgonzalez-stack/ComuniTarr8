  ...
  const officialEvents: Event[] = [
    {
      ...
      description: "Mercadillo semanal de los domingos. ¡No te lo pierdas!",
    ...
    },
    {
      id: 'evt-quema-ninot',
      creator_id: 'admin',
      title: "🔥 Quema del Ninot (Ayer)",
      description: "Adiós al Carnestoltes. Comienzo del Miércoles de Ceniza.",
    ...
    {
      id: 'evt-ceniza-ash-matinal',
      creator_id: 'admin',
      title: "🕯️ Miércoles de Ceniza (Matinal)",
      description: "Primera misa matinal e imposición de la ceniza.",
      event_date: '2026-02-18',
      event_time: '09:00',
      location: 'Catedral / Parroquias',
      category: 'Religioso',
    ...
    {
      id: 'evt-ceniza-ash-tarde',
      creator_id: 'admin',
      title: "🕯️ Miércoles de Ceniza (Misa Central)",
    ...
    },
    {
      ...
      description: "Brigadas municipales retirando restos de Carnival.",
      event_date: '2026-02-18',
      event_time: '08:00',
