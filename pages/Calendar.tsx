      ...
      const realEventsExamples: Event[] = [
        {
          ...
          description: "Hoy viernes día de la mujer. Diversas manifestaciones y lecturas de manifiestos en toda la ciudad.",
        ...
        },
        {
          ...
          description: "Sesión gratuita de yoga para empezar el viernes con energía. Lleva tu esterilla y agua.",
