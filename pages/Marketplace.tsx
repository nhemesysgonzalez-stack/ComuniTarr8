      ...
      const mockItems: MarketItem[] = [
        {
          id: 'm-1',
          user_id: 'v1',
          title: '3 Tickets Calçotada (Juntos)',
          description: 'Nos ha surgido un imprevisto familiar. Los vendo al precio original (12€ c/u).',
          price: '36',
          category: 'ocio',
          neighborhood: 'GENERAL',
          contact_info: '652 11 00 99 (Familia García)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-2',
          user_id: 'v2',
          title: 'Mochila Táctica 40L (Prepper)',
          description: 'Ideal para kit de 72h. Múltiples compartimentos. Color verde oliva. Nueva.',
          price: '40',
          category: 'deporte',
          neighborhood: 'PONENT',
        ...
        },
        {
          id: 'm-3',
          user_id: 'v3',
          title: 'Gafas de Sol RayBan',
          description: 'Originales. Ideales para el solazo de hoy. Las llevo al vermut si te interesan.',
          price: '60',
          category: 'moda',
          neighborhood: 'PART ALTA',
          contact_info: '611 22 33 44 (Alex)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-4',
          user_id: 'v4',
          title: 'Leña de Pino (Seca)',
          description: 'Lista para quemar (o para calçotada si te falta). Saco grande.',
          price: '5',
          category: 'jardineria',
          neighborhood: 'MONNARS',
          contact_info: '699 88 77 66 (Paco)',
          created_at: new Date().toISOString()
        }
      ];
