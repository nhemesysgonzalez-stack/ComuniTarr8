        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                <h4 className="font-black text-gray-400 mb-4 uppercase tracking-widest text-[9px]">Ofertas de Empleo Comprobadas (Lunes 06 Abr)</h4>
                <div className="space-y-4">
                  <div className="border-l-4 border-emerald-500 pl-4">
                    <p className="text-xs font-black dark:text-white">&ldquo;Administrativo Comercial - Lunes a Viernes&rdquo;</p>
