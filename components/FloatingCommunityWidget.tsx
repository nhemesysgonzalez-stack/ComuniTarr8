...
const mockMessages: Message[] = [
    { id: 0, user: 'Admin ComuniTarr', avatar: '/logo.svg', text: "🛒 Hoy Viernes: Mercado Semanal en la Part Alta (Pl. Fòrum). ¡Apoya a los productores locales!", neighborhood: 'GENERAL' },
    { id: 1, user: 'Meteo TGN', avatar: '/logo.svg', text: '☀️ Viernes despejado y agradable. Máxima de 15ºC. ¡Buen día para pasear! 😎', neighborhood: 'GENERAL' },
