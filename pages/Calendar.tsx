...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    ...
    {
      id: 'evt-carnival-rua-infantil',
      creator_id: 'admin',
      title: "🎭 CARNAVAL: Rua de Lluïment Infantil",
      description: "El gran desfile de las escuelas de Tarragona.",
      event_date: '2026-02-13',
      event_time: '16:00',
      location: 'Rambla Nova',
      category: 'Cultura',
    ...
    {
      id: 'evt-weather-cleanup',
      creator_id: 'admin',
      title: "🧹 Brigada Vecinal: Limpieza Post-Viento",
      description: "Quedada para recoger ramas y asegurar macetas en la plaza del barrio.",
      event_date: '2026-02-13',
      event_time: '10:00',
      location: 'Plaza del Barrio',
      category: 'Solidario',
      neighborhood: 'GENERAL',
      contact_info: 'ComuniTarr Voluntarios',
      created_at: new Date().toISOString()
    }
  ];
