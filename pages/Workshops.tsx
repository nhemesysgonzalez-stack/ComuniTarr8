                ...
                <div className="bg-white dark:bg-surface-dark rounded-[40px] border-4 border-dashed border-sky-500/20 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 hover:border-sky-500/40 transition-all">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 font-medium mb-6 max-w-2xl leading-relaxed text-sm md:text-base">
                            Optimiza tu búsqueda de empleo con herramientas de Inteligencia Artificial. HOY MIÉRCOLES a las 10:00h en el Centro Cívico Centre. ¡Inscripción gratuita!
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a href="#" onClick={(e) => { e.preventDefault(); alert("Reserva tu plaza enviando un WhatsApp al 611 00 22 33 para HOY MIÉRCOLES."); }} className="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white rounded-xl text-xs font-black hover:scale-105 transition-all">
