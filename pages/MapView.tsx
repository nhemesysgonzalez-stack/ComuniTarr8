...
const MapView: React.FC = () => {
  ...
  const [pins, setPins] = useState<any[]>([
    ...
    { id: 'lun-23-trastos-1', type: 'event', x: '45%', y: '35%', title: '📋 Recogida Trastos Centro', desc: 'Zona Balmes y Rambla. Sacar muebles antes de las 22h HOY DOMINGO.', status: 'Hoy Activo', color: 'bg-orange-500', icon: 'delete_sweep', glow: 'shadow-[0_0_50px_rgba(249,115,22,0.3)]' },
