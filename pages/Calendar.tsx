...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    {
      id: 'evt-cine-vo-miercoles',
      creator_id: 'admin',
      title: "🎬 Cine en V.O. Subtitulada",
      description: "Proyección de 'Alcarràs'. Coloquio posterior con críticos locales.",
      event_date: '2026-01-28',
      event_time: '18:30',
      location: 'Antiga Audiència',
      category: 'Cultura',
      neighborhood: 'PART ALTA',
      contact_info: 'CineClub TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-taller-digital-ancianos',
      creator_id: 'admin',
      title: "📱 Taller Brecha Digital",
      description: "Ayuda personalizada para mayores con trámites online y apps.",
      event_date: '2026-01-28',
      event_time: '10:30',
      location: 'Centro Cívico Ponent',
      category: 'Solidario',
      neighborhood: 'PONENTE',
      contact_info: 'Fundación Digital',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-reciclaje',
