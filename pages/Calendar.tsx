...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    {
      id: 'evt-reunion-vecinal-lunes',
      creator_id: 'admin',
      title: "🤝 Reunión Proyecto Rambla",
      description: "Presentación del nuevo tramo peatonal. Abierto a sugerencias.",
    ...
    },
    {
      id: 'evt-yoga-playa',
      creator_id: 'admin',
      title: "🧘 Yoga Post-Trabajo",
      description: "Clase gratuita para estirar tras el primer lunes del mes.",
      event_date: '2026-01-26',
      event_time: '18:30',
      location: 'Playa del Miracle',
      category: 'Ocio',
      neighborhood: 'BARRIS MARÍTIMS',
      contact_info: 'Club Wellness TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-reciclaje',
