      ...
      const realEventsExamples: Event[] = [
        {
          id: 'jue-19-san-jose',
          creator_id: 'ayto',
          title: "👔 Día de San José (Día del Padre)",
          description: "Hoy jueves, celebraciones familiares y ambiente festivo. ¡Felicidades a todos los Pepes y Papás de Tarragona!",
        ...
        },
        {
          id: 'jue-19-patrulla',
          creator_id: 'admin',
          title: "🛡️ Patrulla Vecinal: Ronda Nocturna",
          description: "Hoy jueves a las 20:00h nos reunimos para la ronda de seguridad por el centro. Punto de encuentro: C.C. Centre.",
          event_date: '2026-03-19',
          event_time: '20:00',
          location: 'C.C. Centre',
          category: 'Ayuda',
