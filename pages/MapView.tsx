...
const MapView: React.FC = () => {
  ...
  const [pins, setPins] = useState<any[]>([
    ...
    { id: 2, type: 'incident', x: '45%', y: '52%', title: 'Corte Agua EMATSA', desc: 'Suministro afectado hoy lunes hasta las 14:00h en Nou Eixample Sud por obras.', status: 'En curso', color: 'bg-orange-600', icon: 'water_drop', glow: 'shadow-[0_0_35px_rgba(234,88,12,0.4)]' },
    { id: 3, type: 'event', x: '52%', y: '35%', title: 'Cine Forum Sant Pere', desc: "Proyección hoy lunes a las 19:00h: 'Todo sobre mi madre'. Centro Cívico.", status: '19:00h Today', color: 'bg-indigo-500', icon: 'movie_edit' },
