      ...
      const realEventsExamples: Event[] = [
        {
          ...
          description: "Miércoles 18 Mar: Reunión para comentar 'La plaça del Diamant' en el C.C. Part Alta. ¡Trae tus notas!",
          event_date: '2026-03-18',
          event_time: '18:30',
          location: 'Centro Cívico Part Alta',
          category: 'Cultura',
          neighborhood: 'GENERAL',
          contact_info: 'Elena P. — Foro Cultura',
          created_at: new Date().toISOString()
        },
        {
          id: 'mie-18-volunt',
          creator_id: 'admin',
          title: "🤝 Taller: Formación Voluntariado",
          description: "Hoy miércoles sesión de formación para nuevos voluntarios que quieran ayudar en el Banco de Alimentos.",
          event_date: '2026-03-18',
          event_time: '17:00',
          location: 'C.C. San Salvador',
          category: 'Cultura',
          neighborhood: 'GENERAL',
        ...
        },
        {
          id: 'jue-19-patrulla',
          creator_id: 'admin',
          title: "🛡️ Patrulla Vecinal: Seguridad",
          description: "Mañana jueves ronda informativa por la zona centro. Coordinación de puntos ciegos.",
        ...
        },
        {
          ...
          description: "Gran trobada canina a Tivissa: exhibicions d'agility i pastoreig, food trucks i concursos per a gossos grans.",
