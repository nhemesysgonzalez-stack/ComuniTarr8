...
export const Header: React.FC = () => {
  ...
  const mockNotifications = [
    ...
    { id: 2, title: 'Evento Cerca', desc: 'Paella popular este jueves', time: 'Hace 1h', icon: 'event', color: 'text-primary' },
    ...
    <div className="sticky top-0 z-[60] w-full max-w-full overflow-x-hidden">
      ...
      <div className="bg-fuchsia-600/95 backdrop-blur-md py-1.5 overflow-hidden border-b border-white/10 relative w-full max-w-full">
        ...
        >
          ...
          <span className="opacity-30">•</span>
          <span className="flex items-center gap-2">♻️ RECICLAJE: Hoy jueves RECOGIDA DE MUEBLES Y VOLUMINOSOS EN ZONA CENTRO (20-22H)</span>
        </motion.div>
      </div>
            ...
            <div className="pt-8 pb-10 px-8 space-y-8">
              ...
              <div className="flex items-center justify-between px-2">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-black dark:text-white uppercase">Jueves 12 Mar 2026</span>
