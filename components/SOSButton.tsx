    ...
    return (
        <>
            <motion.button
                ...
                className="fixed bottom-24 right-8 lg:bottom-8 lg:right-32 z-[100] size-16 lg:size-20 bg-red-600 text-white rounded-full shadow-[0_0_40px_rgba(220,38,38,0.5)] flex items-center justify-center group overflow-hidden border-4 border-white dark:border-gray-800"
            >
                <motion.div
