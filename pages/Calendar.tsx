  ...
  const officialEvents: Event[] = [
    {
      id: 'evt-mon-market',
      creator_id: 'admin',
      title: "🛍️ Mercadillo Bonavista (Hoy)",
      description: "Especial Telas y Disfraces. ¡Aprovecha para tu comparsa!",
    ...
    {
      id: 'evt-carnival-dijous-gras',
      creator_id: 'admin',
      title: "🎭 CARNAVAL: Dijous Gras",
      description: "Reparto de Coca de Llardones y Butifarra de Huevo. ¡Empieza la fiesta!",
      event_date: '2026-02-12',
      event_time: '18:00',
      location: 'Rambla Nova',
      category: 'Fiesta',
      neighborhood: 'CENTRO',
      contact_info: 'Comissió Carnaval',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-carnival-rueta',
      creator_id: 'admin',
      title: "🧒 CARNAVAL: La Rueta (Infantil)",
      description: "Desfile de los colegios y guarderías de la ciudad.",
      event_date: '2026-02-13',
      event_time: '10:00',
      location: 'Part Alta - Rambla',
      category: 'Fiesta',
      neighborhood: 'CENTRO',
      contact_info: 'Departament Educació',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-carnival-rua-artesania',
      creator_id: 'admin',
      title: "👑 CARNAVAL: Gran Rua de l'Artesania",
      description: "El desfile principal. Comparsas, plumas y brillo. ¡No te lo pierdas!",
      event_date: '2026-02-14',
      event_time: '18:00',
      location: 'Av. Ramón y Cajal -> Rambla Nova',
      category: 'Fiesta',
    ...
    },
    {
      ...
      description: "Desfile de las comparsas ganadoras del año pasado.",
    ...
    {
      id: 'evt-velatorio-sardina',
      creator_id: 'admin',
      title: "⚰️ Velatori d'en Carnestoltes",
      description: "Última oportunidad para despedir a Sus Majestades. Casa de la Festa y Pl. de la Font.",
    ...
    },
    {
      id: 'evt-quema-ninot',
      creator_id: 'admin',
      title: "🔥 Lectura de Testamento y Quema",
      description: "Sentencia final y quema de los Ninots. Espectáculo de fuego y sátira.",
      event_date: '2026-02-17',
      event_time: '20:00',
      location: 'Plaza de la Font',
      category: 'Festivo',
    ...
    {
      id: 'evt-entierro-sardina',
      creator_id: 'admin',
      title: "🐟 Enterrament de la Sardina",
      description: "Cortejo fúnebre por las calles de la Part Alta. Se recomienda vestir de luto.",
      event_date: '2026-02-17',
      event_time: '21:00',
      location: 'Antiga Audiència -> Pl. de la Font',
      category: 'Tradición',
      neighborhood: 'GENERAL',
      contact_info: 'Voluntarios TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-ceniza-ash',
      creator_id: 'admin',
      title: "🕯️ Miércoles de Ceniza",
      description: "Imposición de la ceniza y comienzo de la Cuaresma.",
      event_date: '2026-02-18',
      event_time: '19:30',
      location: 'Catedral de Tarragona',
      category: 'Religioso',
      neighborhood: 'PART ALTA',
      contact_info: 'Arquebisbat TGN',
      created_at: new Date().toISOString()
    }
  ];
