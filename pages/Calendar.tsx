...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    ...
    },
    {
      id: 'evt-tres-tombs',
      creator_id: 'admin',
      title: "🐎 Els Tres Tombs de Tarragona",
      description: "Tradicional desfile y bendición de animales. Recorrido por la Rambla Nova.",
      event_date: '2026-02-15',
      event_time: '11:30',
      location: 'Rambla Nova',
      category: 'Cultura',
      neighborhood: 'CENTRO',
      contact_info: 'Arrieros de TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-rua-lluiment',
      creator_id: 'admin',
      title: "✨ Rua de Lluïment de Carnaval",
      description: "Desfile de las comparsas premiadas y las más espectaculares del año anterior.",
      event_date: '2026-02-15',
      event_time: '18:00',
      location: 'Av. Ramón y Cajal -> Av. Catalunya',
      category: 'Festivo',
      neighborhood: 'GENERAL',
    ...
    },
    {
      id: 'evt-cleanup-comm',
      creator_id: 'admin',
      title: "🧹 Quedada Limpieza Vecinal",
      description: "Ayudamos a las brigadas a recoger el confeti de nuestras puertas tras la fiesta.",
      event_date: '2026-02-15',
      event_time: '10:00',
      location: 'Plaza de la Font / Rambla',
      category: 'Servicio',
      neighborhood: 'GENERAL',
      contact_info: 'Voluntarios ComuniTarr',
      created_at: new Date().toISOString()
    }
  ];
