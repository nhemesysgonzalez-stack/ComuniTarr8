      ...
      const mockChallenges: Challenge[] = [
        {
          ...
          description: 'Hoy jueves, ¡ve al mercado de la Part Alta con tus propias bolsas de tela! El reto es no usar ni un solo plástico de un solo uso en toda la compra.',
