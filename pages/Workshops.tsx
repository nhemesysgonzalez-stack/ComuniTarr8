                ...
                <div className="bg-white dark:bg-surface-dark rounded-[40px] border-4 border-dashed border-sky-500/20 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 hover:border-sky-500/40 transition-all">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 font-medium mb-6 max-w-2xl leading-relaxed text-sm md:text-base">
                            Optimiza tu búsqueda de empleo con herramientas de Inteligencia Artificial. HOY DOMINGO a las 10:00h en el Centro Cívico Centre. ¡Inscripción gratuita!
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a href="#" onClick={(e) => { e.preventDefault(); alert("Reserva tu plaza enviando un WhatsApp al 611 00 22 33 para HOY DOMINGO."); }} className="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white rounded-xl text-xs font-black hover:scale-105 transition-all">
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-3xl mb-4 text-center">
                                    ...
                                    <div className="flex flex-wrap gap-2 justify-center">
                                        {[
                                            ...
                                            { t: 'Smartphone Pro', i: 'Marta G.', d: 'domingo 10:30', desc: 'Sácale provecho a tu móvil para gestiones y búsqueda activa.', c: '699222333' },
                                            { t: 'Gestión del Tiempo', i: 'M. López', d: 'Domingo 18:00', desc: 'Técnicas para organizar tu semana y reducir el estrés laboral.', c: '611444555' },
                                            { t: 'Networking TGN', i: 'Hub Impulsa', d: 'Domingo 19:30', desc: 'Encuentro informal para conectar con otros profesionales locales.', c: 'Tabacalera Sala 2' }
                                        ].map((idea, i) => (
                                            <button
                                                key={i}
                                                type="button"
                                ...
                                <div>
                                    ...
                                    <input type="text" value={date} onChange={e => setDate(e.target.value)} required className="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-2xl px-4 py-3 font-bold dark:text-white outline-none ring-emerald-500/20 focus:ring-2" placeholder="Ej: Domingo 18:30" />
                                </div>
