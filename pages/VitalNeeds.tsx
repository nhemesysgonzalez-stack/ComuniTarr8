            ...
            <main className="max-w-6xl mx-auto p-6 md:p-12 -mt-10 relative z-20">
                ...
                <section className="mb-12 bg-white dark:bg-surface-dark rounded-[40px] p-8 shadow-xl border border-gray-100 dark:border-gray-800 flex flex-col md:flex-row items-center gap-8 border-l-[12px] border-l-red-500">
                    ...
                    <div className="flex flex-col gap-3 shrink-0 w-full md:w-auto">
                        <a href="#" onClick={(e) => { e.preventDefault(); alert('Inscripción abierta: Centro Cívico Centro. Sesión hoy lunes a las 18h.'); }} className="px-6 py-4 bg-red-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all text-center flex items-center justify-center gap-2">
