  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const realNewsExamples = [
          {
            ...
            content: 'Atención vecinos de la zona Centro: HOY MIÉRCOLES toca recogida de muebles y voluminosos. Por favor, sacad los objetos a la calle antes de las 22:00h.',
            neighborhood: 'CENTRE',
            category: 'AVISO',
        ...
        const pollExample = {
          id: 'lun-23-poll-1',
          question: "📊 ¿Cómo ha sido tu vuelta a la rutina HOY MIÉRCOLES?",
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-bold text-primary uppercase tracking-widest bg-primary/10 px-2 py-1 rounded-lg">Semana 13 · Mié 25 Mar</span>
            </div>
