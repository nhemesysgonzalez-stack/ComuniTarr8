    ...
    try {
      ...
      const patrolExamples: PatrolGroup[] = [
        ...
        },
        {
          ...
          description: 'Hoy miércoles patrulla informativa para fomentar la recogida de cacas y el uso de correa en zonas concurridas. Regalamos bolsas reciclables.',
          neighborhood: 'GENERAL',
