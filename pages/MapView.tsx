...
const MapView: React.FC = () => {
  ...
  const [pins, setPins] = useState<any[]>([
    { id: 'mar-07-weather', type: 'weather', x: '52%', y: '42%', title: '☀️ Martes: Soleado 22ºC', desc: 'Arrancamos la semana con cielos despejados e ideal para caminar.', status: 'Despejado 22ºC', color: 'bg-sky-500', icon: 'wb_sunny' },
    { id: 'mar-07-trastos-1', type: 'event', x: '45%', y: '35%', title: '📋 Recogida Trastos Centro', desc: 'Zona Balmes y Rambla. Sacar muebles antes de las 22h HOY MARTES.', status: 'Hoy Activo', color: 'bg-orange-500', icon: 'delete_sweep', glow: 'shadow-[0_0_50px_rgba(249,115,22,0.3)]' },
    { id: 'mar-07-trastos-2', type: 'event', x: '48%', y: '45%', title: '📋 Recogida Trastos Norte', desc: 'Punto de recogida muebles esta noche. Por favor, mantened libre el paso.', status: 'Hoy Activo', color: 'bg-orange-500', icon: 'delete_sweep' },
    { id: 'mar-07-seguridad', type: 'incident', x: '55%', y: '50%', title: '🛡️ Seguridad Escolar', desc: 'Refuerzo de patrullas vecinales en el acceso al Colegio Miracle desde las 08:30h.', status: 'Activo Martes', color: 'bg-emerald-500', icon: 'check_circle' },
