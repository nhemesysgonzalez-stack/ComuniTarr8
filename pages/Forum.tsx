  ...
  const conversationThreads: Record<string, Array<Array<{ who: string; text: string }>>> = {
    ...
    'APOYO': [
      [
        ...
        { who: 'Andreu T.', text: 'Abierto desde las 8h hoy martes, Carme. Todo volviendo a la normalidad.' },
      ],
      [
    ...
    'EMPLEO': [
      [
        ...
        { who: 'Restaurant Sol', text: 'Hoy 2 de Junio trabajamos fuerte. Buscamos refuerzo urgente para camareros los fines de semana. Tel: 977 12 34 56' },
      ],
    ],
    'ENCUENTROS': [
      [
    ...
    if (!loading && seedsInjectedRef.current !== currentNeighborhood) {
      ...
      const seedsByChannel: Record<string, Message[]> = {
        'GENERAL': [
          ...
          // Hoy Martes 2
          { id: 'seed-cloud-101', user_id: 'v3', content: `📚 ¿Alguien ya ha empezado su libro de Sant Jordi? Yo llevo ya 50 páginas del mío. 😄`, user_metadata: { full_name: 'Joan B.', avatar_url: 'https://i.pravatar.cc/150?u=joan' }, neighborhood: 'GENERAL', created_at: '2026-06-02T08:30:00Z' },
          { id: 'seed-cloud-102', user_id: 'v2', content: '🎡 La Feria de Bonavista acaba de abrir. ¡Hay sevillanas, comida andaluza y mucha alegría! ¡Ven esta tarde!', user_metadata: { full_name: 'Mireia R.', avatar_url: 'https://i.pravatar.cc/150?u=mireia' }, neighborhood: 'GENERAL', created_at: '2026-06-02T11:00:00Z' },
        ] as Message[],
      };
    ...
    <div className={`flex h-[calc(100vh-80px)] font-sans transition-all duration-300 ${isShaking ? 'shake' : ''} bg-[#f8fafc] dark:bg-[#0f172a]`} onClick={unlockAudio}>
      ...
      <div className="hidden md:flex w-80 flex-col bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-r border-[#e2e8f0] dark:border-white/5 z-10 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8">
          ...
          {/* Trending Topics - Actualizado Viernes 2 Junio */}
          <div>
