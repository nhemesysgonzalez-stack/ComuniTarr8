...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    {
      id: 'evt-taller-cocina-martes',
      creator_id: 'admin',
      title: "🍳 Taller Cocina Mediterránea",
      description: "Recetas de temporada con productos del mercado. Inscripción gratuita.",
      event_date: '2026-01-27',
      event_time: '17:30',
      location: 'Mercat Central (Sala Taller)',
      category: 'Ocio',
      neighborhood: 'CENTRO',
      contact_info: 'Espai Cuina TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-charla-emprendedores',
      creator_id: 'admin',
      title: "💡 Networking Emprendedores",
      description: "Encuentro para compartir ideas y proyectos locales.",
      event_date: '2026-01-27',
      event_time: '18:00',
      location: 'Tarragona Impulsa',
      category: 'Solidario',
      neighborhood: 'PART ALTA',
      contact_info: 'TGN Impulsa',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-reciclaje',
