      ...
      const mockChallenges: Challenge[] = [
        {
          ...
          description: 'Hoy martes, por el 8M, comparte una lectura inspiradora de una autora mujer.',
              ...
              <form onSubmit={handleChallengeSubmit} className="space-y-4">
                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-3xl mb-4 text-center">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center">
                    {[
                      { t: 'Donación de Libros', d: 'Llevamos libros a la biblioteca del barrio para renovar stock infantil tras el martes de cole.', c: '977240331' },
                      ...
                      { t: 'Limpieza de alcorques', d: 'Iniciativa para limpiar la tierra de los árboles de nuestra calle este martes por la tarde.', c: '611888222' }
                    ].map((idea, i) => (
                      <button
                        key={i}
                        type="button"
