                ...
                <section className="mb-12 bg-white dark:bg-surface-dark rounded-[40px] p-8 shadow-xl border border-gray-100 dark:border-gray-800 flex flex-col md:flex-row items-center gap-8 border-l-[12px] border-l-red-500">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                            ¿Tienes 1 hora libre esta semana? Únete a nuestra red de acompañamiento para personas mayores que viven solas. Paseos, compra, o una simple charla. Un pequeño gesto marca la diferencia. Nos reunimos Hoy Lunes a las 18h en el Serrallo para coordinar la semana de Sant Jordi.
                        </p>
                    </div>
