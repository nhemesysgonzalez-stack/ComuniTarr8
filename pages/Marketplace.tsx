      ...
      const mockItems: MarketItem[] = [
        {
          id: 'm-1',
          user_id: 'v1',
          title: 'Disfraz Spiderman Adulto',
          description: 'Usado una vez. Talla L. Buena calidad (con relleno muscular). Lo vendo porque este año vamos de Piratas.',
          price: '20',
          category: 'moda',
          neighborhood: 'CENTRO',
          contact_info: '652 11 00 99 (David)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-2',
          user_id: 'v2',
          title: 'Generador Eléctrico Portátil',
          description: 'Marca Honda. Pequeño. Ideal para apagones o camping. Revisado por Preppers.',
          price: '150',
          category: 'bricolaje',
          neighborhood: 'PONENT',
        ...
        },
        {
          ...
          description: 'Antigua pero funciona. La vendo por falta de espacio. Regalo caja de hilos.',
          price: '45',
          category: 'hogar',
          neighborhood: 'TORREFORTA',
          contact_info: '611 22 33 44 (Carmen)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-4',
          user_id: 'v4',
          title: 'Bicicleta Niño 16"',
          description: 'Se le ha quedado pequeña. Buen estado. Ruedines incluidos.',
          price: '30',
          category: 'deporte',
          neighborhood: 'S. PERE I S. PAU',
          contact_info: '699 88 77 66 (Javi)',
          created_at: new Date().toISOString()
        }
      ];
