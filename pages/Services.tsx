        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                <h4 className="font-black text-gray-400 mb-4 uppercase tracking-widest text-[9px]">Ofertas de Empleo Comprobadas (Hoy Vie 13 Mar)</h4>
              ...
              <div className="bg-white dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[9px] text-gray-400 font-bold mt-2">💡 Hoy Viernes 13 Mar: Actos institucionales Día de la Mujer. Mañana Lunes: Talleres TGN Impulsa.</p>
                  </div>
                </div>
              </div>
