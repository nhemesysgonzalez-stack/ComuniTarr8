            ...
            <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-3xl border border-blue-100 dark:border-blue-800/30">
              ...
              <div className="p-4 bg-white dark:bg-surface-dark rounded-xl border border-green-200 dark:border-green-800 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 uppercase">Todas las líneas de la EMT operan según sus horarios de DÍAS FESTIVOS (Lunes 2 Junil). L25 reforzada hacia Bonavista.</p>
                </div>
              </div>
            </div>
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                <h4 className="font-black text-gray-400 mb-4 uppercase tracking-widest text-[9px]">Ofertas de Empleo Comprobadas (Mar 2 Jun)</h4>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-3xl border border-blue-100 dark:border-blue-800/30">
              ...
              <div className="flex items-center gap-4 bg-white dark:bg-surface-dark p-4 rounded-2xl shadow-sm mb-3">
                <div className="size-12 rounded-xl bg-red-100 dark:bg-red-900/30 flex items-center justify-center text-red-600 font-bold text-xl">
                  1
                </div>
                <div>
                  <p className="text-xs font-black uppercase text-red-500">VIERNES</p>
                  <p className="text-sm font-bold text-gray-800 dark:text-white">Día Festivo (2 de Junio)</p>
              ...
              <div className="bg-white dark:bg-surface-dark p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[9px] text-gray-400 font-bold mt-2">💡 HOY MARTES 2 Jun: Toda la red de Centros y Casales Cívicos permanecerá cerrada por festividad nacional.</p>
                  </div>
                </div>
              </div>
