  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const realEventsExamples: Event[] = [
        {
          id: 'mar-17-orientacion',
          creator_id: 'admin',
          title: "💼 HOY: Orientación Laboral +45",
          description: "Hoy martes sesión grupal en el Centro Cívico Centre. Ayuda personalizada para mejorar tu búsqueda de empleo.",
        ...
        },
        {
          ...
          description: "Hoy martes sesión de apoyo emocional y acompañamiento en la Part Alta. ¡No estás solo!",
          event_date: '2026-03-17',
          event_time: '11:00',
          location: 'Local Social Part Alta',
          category: 'Cultura',
          neighborhood: 'GENERAL',
        ...
        },
        {
          ...
          description: "Esta semana comentamos 'La plaça del Diamant' de Mercè Rodoreda. Abierto a todos.",
          event_date: '2026-03-18',
          event_time: '18:30',
          location: 'Biblioteca Pública TGN',
          category: 'Cultura',
          neighborhood: 'GENERAL',
          contact_info: 'Biblioteca TGN — 977 24 03 31',
          created_at: new Date().toISOString()
        },
        {
