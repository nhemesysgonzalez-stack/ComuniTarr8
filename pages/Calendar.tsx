...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    ...
    },
    {
      id: 'evt-juicio-1',
      creator_id: 'admin',
      title: "⚖️ Juici al Rei Carnestoltes",
      description: "Primera sesión del juicio satírico a los Reyes del Carnaval. Entradas en taquilla.",
    ...
    },
    {
      id: 'evt-juicio-2',
      creator_id: 'admin',
      title: "⚖️ Juici al Rei Carnestoltes (Sesión 2)",
      description: "Segunda sesión y veredicto final. ¿Serán condenados a la hoguera?",
      event_date: '2026-02-16',
      event_time: '20:00',
      location: 'Teatre Metropol',
      category: 'Cultura',
    ...
    {
      id: 'evt-cleanup-monday',
      creator_id: 'admin',
      title: "🧹 Operación Confeti: Lunes",
      description: "Quedada para retirar restos de carrozas y purpurina en los barrios periféricos.",
      event_date: '2026-02-16',
      event_time: '10:00',
      location: 'Centros Cívicos',
      category: 'Servicio',
      neighborhood: 'GENERAL',
