      ...
      const realEventsExamples: Event[] = [
        {
          ...
          description: "Hoy miércoles día de la mujer. Diversas manifestaciones y lecturas de manifiestos en toda la ciudad.",
        ...
        },
        {
          ...
          description: "Sesión gratuita de yoga para empezar el miércoles con energía. Lleva tu esterilla y agua.",
          event_date: '2026-03-08',
          event_time: '10:00',
          location: 'Parc del Francolí',
          category: 'Cultura',
          neighborhood: 'GENERAL',
