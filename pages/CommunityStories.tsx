...
const CommunityStories: React.FC = () => {
    ...
    const fetchStories = async () => {
        ...
        const mockStories = [
            { id: 'dom-22-s1', user_name: 'Ana T.', content: '🥾 ¡Caminata completada! 6km de puro sol y risas por el Camí de Ronda. ¡Lo hemos pasado genial HOY JUEVES! ☀️✨ #Caminata #Tarragona #Naturaleza #Domingo', image_url: 'https://images.unsplash.com/photo-1551632811-561732d1e306', likes: 210, created_at: new Date().toISOString() },
