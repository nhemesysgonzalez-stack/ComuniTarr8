...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    {
      id: 'evt-fri-lent-serrallo',
      creator_id: 'admin',
      title: "🐟 Menú de Vigilia - Viernes Cuaresma",
      description: "Primer viernes de Cuaresma. Restaurantes del Serrallo ofrecen menú de vigilia con bacalao y pescado fresco desde 12€.",
      event_date: '2026-02-20',
      event_time: '13:00',
      location: 'El Serrallo',
      category: 'Gastronomía',
      neighborhood: 'EL SERRALLO',
      contact_info: 'Assoc. Hostelería TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-carnival-lluiment',
      creator_id: 'admin',
      title: "✨ CARNAVAL: Rua de Lluïment",
      description: "Desfile de las comparsas ganadoras. ¡Resaca de purpurina!",
      event_date: '2026-02-15',
      event_time: '11:00',
      location: 'Rambla Nova',
      category: 'Fiesta',
      neighborhood: 'CENTRO',
      contact_info: 'Turisme Tarragona',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-fri-teatro',
      creator_id: 'admin',
      title: "🎭 Teatro Metropol: 'Cyrano'",
      description: "Estreno de la obra 'Cyrano de Bergerac'. Entrada 15€. Reservas en taquilla o web Metropol.",
      event_date: '2026-02-20',
      event_time: '20:30',
    ...
    },
    {
      id: 'evt-fri-farmacia',
      creator_id: 'admin',
      title: "💊 Farmacia de Guardia (Viernes noche)",
      description: "Farmacia de turno esta noche: Farmàcia Sabaté (Rambla Nova, 85). Abierta 24h.",
      event_date: '2026-02-20',
      event_time: '21:00',
      location: 'Rambla Nova, 85',
      category: 'Servicios',
      neighborhood: 'GENERAL',
      contact_info: '977 21 00 00',
      created_at: new Date().toISOString()
    },
    {
      ...
      description: "Mercado de productores locales. Fruta, verdura y artesanía de proximidad. ¡Lleva tu bolsa!",
    ...
    {
      id: 'evt-sat-ruta-muralla',
      creator_id: 'admin',
      title: "🏛️ Ruta Guiada: Muralla Romana",
      description: "Visita guiada gratuita por la muralla romana. Plazas limitadas. Inscripción previa en el Museu d'Història.",
      event_date: '2026-02-21',
      event_time: '11:00',
      location: 'Portal del Roser',
      category: 'Cultura',
      neighborhood: 'PART ALTA',
      contact_info: '977 24 19 52 (Museu)',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-sat-yoga',
      creator_id: 'admin',
      title: "🧘 Yoga en el Anfiteatro",
      description: "Sesión de yoga gratuita al aire libre con vistas al mar. Trae tu esterilla. Organiza: Associació Ment i Cos.",
      event_date: '2026-02-21',
      event_time: '10:00',
      location: 'Anfiteatro Romano',
      category: 'Salud',
      neighborhood: 'BARRIS MARÍTIMS',
      contact_info: '622 100 200 (Marta)',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-sun-running',
      ...
      description: "5K solidaria por el Paseo Marítimo. Beneficia a Càritas Diocesana. Inscripción en la meta desde las 9h.",
    ...
    {
      id: 'evt-sun-lent-tapas',
      creator_id: 'admin',
      title: "🐟 Ruta de Tapas de Cuaresma",
      description: "Segundo día de la ruta de tapas de vigilia. Bares del Serrallo ofrecen bacalao, calamar y patatas bravas de vigilia a 3€.",
      event_date: '2026-02-22',
      event_time: '12:00',
      location: 'El Serrallo',
      category: 'Gastronomía',
    ...
    {
      id: 'evt-week-talent-senior',
      creator_id: 'admin',
      title: "💼 Taller: Reinvención Laboral +45",
      description: "Taller gratuito de orientación laboral para mayores de 45. Impartido por Tarragona Impulsa.",
      event_date: '2026-02-24',
      event_time: '10:00',
      location: 'Tabacalera (Tarragona Impulsa)',
      category: 'Empleo',
      neighborhood: 'GENERAL',
      contact_info: '977 29 55 00 (TGN Impulsa)',
      created_at: new Date().toISOString()
    }
  ];
