  ...
  const officialEvents: Event[] = [
    {
      id: 'evt-thu-market',
      creator_id: 'admin',
      title: "🛍️ Mercadillo Semanal",
      description: "Fruta, verdura y artesanía local. Especial conservas hoy.",
      event_date: '2026-02-05',
      event_time: '09:00',
      location: 'Part Alta - Plaça del Fòrum',
      category: 'Ocio',
    ...
    },
    {
      id: 'evt-thu-plaseqta',
      creator_id: 'admin',
      title: "🚨 Simulacro PLASEQTA",
      description: "Prueba de sirenas de riesgo químico. No requiere confinamiento real.",
      event_date: '2026-02-05',
      event_time: '12:00',
      location: 'Toda la ciudad',
      category: 'Solidario',
      neighborhood: 'GENERAL',
      contact_info: 'Protección Civil 112',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-thu-preppers',
      creator_id: 'admin',
      title: "🔦 Taller: 'Si Se Va La Luz'",
      description: "Aprende a conservar alimentos y gestionar apagones con seguridad.",
      event_date: '2026-02-05',
      event_time: '18:30',
