      ...
      const realEventsExamples: Event[] = [
        {
          ...
          description: "Hoy lunes día de la mujer. Diversas manifestaciones y lecturas de manifiestos en toda la ciudad.",
        ...
        },
        {
          ...
          description: "Sesión gratuita de yoga para empezar el lunes con energía. Lleva tu esterilla y agua.",
