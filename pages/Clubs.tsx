            ...
            const mockClubs: Club[] = [
                {
                    ...
                    description: 'Entrenamiento de series hoy sábado a las 19:30h. Quedamos frente al Hotel Imperial Tarraco. ¡Apto para todos los niveles!',
                ...
                },
                {
                    ...
                    description: 'Nos reunimos cada sábado en la cafetería del Serrallo a las 17:30h para tejer y charlar. ¡Trae tus agujas!',
                            ...
                            <form onSubmit={handleClubSubmit} className="space-y-4">
                                <div className="p-4 bg-pink-50 dark:bg-pink-900/10 rounded-3xl mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-2 justify-center">
                                        {[
                                            { t: 'Pádel Sábado', d: 'Buscamos pareja para jugar hoy a las 20h en las pistas municipales.', c: '611222333' },
                                            { t: 'Club de Cine', d: 'Quedadas para ir a los Cine Forum y comentar las películas luego con un café.', c: '644555666' },
                                            { t: 'Intercambio Inglés', d: 'Hablamos inglés los sábado tarde en la cafetería X de forma relajada.', c: '677888999' }
                                        ].map((idea, i) => (
                                            <button
                                                key={i}
                                                type="button"
