            ...
            const realOpportunitiesExamples: VolunteerOpportunity[] = [
                {
                    ...
                    description: 'Estaré en la salida del mercado de 11h a 13h hoy sábado para ayudar a personas mayores a llevar las bolsas pesadas hasta su casa o el coche.',
                            ...
                            <form onSubmit={handleOpportunitySubmit} className="space-y-4">
                                <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-3xl mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-2 justify-center">
                                        {[
                                            { t: 'Ayuda Mercado', d: 'Busco voluntario para ayudar a bajar 3 pisos sin ascensor y acompañar al mercado de hoy sábado.', c: '644 33 22 11' },
