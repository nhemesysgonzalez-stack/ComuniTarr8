      ...
      const mockItems: MarketItem[] = [
        {
          id: 'm-1',
          user_id: 'v1',
          title: 'Pack Cinta Americana (3 rollos)',
          description: 'Compré de más para el kit de prepper. Cinta extra fuerte para sellar ventanas. 10€ los 3.',
          price: '10',
          category: 'bricolaje',
          neighborhood: 'PONENT',
          contact_info: '652 11 00 99 (PrepperTGN)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-2',
          user_id: 'v2',
          title: 'Cortavientos Nike Talla L',
          description: 'Casi nuevo. Ideal para días como hoy. Impermeable y frena el viento 100%.',
          price: '25',
          category: 'moda',
          neighborhood: 'CENTRO',
          contact_info: '633 44 55 66 (Marc)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-3',
          user_id: 'v3',
          title: 'Sacos de Confeti Biodegradable',
          description: 'Sobras de una fiesta. 3 sacos grandes de colores. Perfectos para la Rua o fiestas.',
          price: '15',
          category: 'ocio',
          neighborhood: 'S. PERE I S. PAU',
          contact_info: '611 22 33 44 (Javi)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-4',
          user_id: 'v4',
          title: 'Entrada "Disbauxa" (Sábado)',
          description: 'No puedo ir por trabajo. La vendo al mismo precio de coste. Zona VIP.',
          price: '30',
          category: 'ocio',
          neighborhood: 'PART ALTA',
          contact_info: '699 88 77 66 (Laura)',
          created_at: new Date().toISOString()
        }
      ];
