            ...
            const mockClubs: Club[] = [
                {
                    ...
                    description: 'Trote suave HOY MIÉRCOLES tarde. Quedamos a las 19:30h en el Balcó. ¡Aprovecha la fresca!',
                ...
                },
                {
                    ...
                    description: 'HOY MIÉRCOLES salimos a fotografiar el bullicio del Mercado de Corsini a las 11:00h. ¡Vente con tu cámara!',
                    neighborhood: 'GENERAL',
                ...
                },
                {
                    ...
                    description: 'Recordatorio: Mañana miércoles tenemos la sesión mensual. HOY MIÉRCOLES terminamos de comentar el último capítulo en el chat.',
                    neighborhood: 'GENERAL',
                            ...
                            <form onSubmit={handleClubSubmit} className="space-y-4">
                                <div className="p-4 bg-pink-50 dark:bg-pink-900/10 rounded-3xl mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-2 justify-center">
                                        {[
                                            { t: 'Fútbol Lunes', d: 'Buscamos gente para completar partido HOY MIÉRCOLES a las 20h en Campclar.', c: '611222333' },
