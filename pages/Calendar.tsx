...
const NeighborhoodCalendar: React.FC = () => {
  ...
  const officialEvents: Event[] = [
    ...
    },
    {
      ...
      creator_id: 'admin',
      title: "🎭 CARNAVAL: Gran Rua de l'Artesania",
      description: "El desfile principal con más de 30 comparsas y toda la magia del Carnaval.",
      event_date: '2026-02-14',
      event_time: '18:00',
      location: 'Av. Ramón y Cajal -> Rambla Nova',
      category: 'Cultura',
    ...
    {
      id: 'evt-baixada-pajaritu',
      creator_id: 'admin',
      title: "🏎️ XIX Baixada del Pajaritu",
      description: "Espectáculo y humor en la bajada de trastos disfrazados más famosa.",
      event_date: '2026-02-14',
      event_time: '11:00',
      location: 'Cós del Bou / Peixateria',
      category: 'Festivo',
      neighborhood: 'PART ALTA',
      contact_info: 'Pajaritus TGN',
      created_at: new Date().toISOString()
    },
    {
      id: 'evt-valentine-concert',
      creator_id: 'admin',
      title: "❤️ Sant Valentí: Cena y Música en Vivo",
      description: "Varios restaurantes del centro ofrecen menús especiales con música hoy.",
      event_date: '2026-02-14',
      event_time: '21:00',
      location: 'Part Alta / Serrallo',
      category: 'Ocio',
      neighborhood: 'GENERAL',
      contact_info: 'Ver Local Businesses',
      created_at: new Date().toISOString()
    }
  ];
