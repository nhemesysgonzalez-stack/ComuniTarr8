      ...
      const mockItems: MarketItem[] = [
        {
          id: 'm-1',
          user_id: 'v1',
          title: 'Leña Sobrante Calçotada',
          description: 'Nos ha sobrado medio maletero de leña de sarmiento. La regalo a quien venga a buscarla a S. Salvador.',
          price: 'Gratis',
          category: 'jardineria',
          neighborhood: 'S. SALVADOR',
          contact_info: '652 11 00 99 (Javi)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-2',
          user_id: 'v2',
          title: 'Horno Solar Casero (Planos)',
          description: 'Vendo los planos y lista de materiales para construir el horno solar que llevé hoy. Funciona a 150°C.',
          price: '5',
          category: 'bricolaje',
          neighborhood: 'PONENT',
        ...
        },
        {
          id: 'm-3',
          user_id: 'v3',
          title: 'Silla Camping Plegable',
          description: 'Usada solo hoy. Como nueva. Color azul.',
          price: '10',
          category: 'ocio',
          neighborhood: 'GENERAL',
          contact_info: '611 22 33 44 (Marta)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-4',
          user_id: 'v4',
          title: 'Juego Tuppers Cristal',
          description: 'Ideales para guardar sobras de comida. Pack de 4. Sin estrenar.',
          price: '15',
          category: 'hogar',
          neighborhood: 'GENERAL',
