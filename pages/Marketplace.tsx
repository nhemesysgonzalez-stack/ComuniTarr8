      ...
      const mockItems: MarketItem[] = [
        {
          id: 'm-1',
          user_id: 'v1',
          title: '2 Entradas Tributo Queen (Sala Zero)',
          description: 'Para ESTA NOCHE. No puedo ir por trabajo. Las dejo a mitad de precio.',
          price: '20',
          category: 'ocio',
          neighborhood: 'GENERAL',
          contact_info: '652 11 00 99 (Laura)',
          created_at: new Date().toISOString()
        },
        {
          id: 'm-2',
          user_id: 'v2',
          title: 'Máscara Antigás Industrial (Nueva)',
          description: 'Compré dos por error para mi kit de emergencia. Precintada. Filtro ABEC.',
          price: '35',
          category: 'hogar',
          neighborhood: 'PONENT',
        ...
        },
        {
          id: 'm-3',
          user_id: 'v3',
          title: 'Bicicleta Montaña Talla M',
          description: 'Ideal para las rutas de este fin de semana. Recién revisada.',
          price: '120',
          category: 'deporte',
          neighborhood: 'GENERAL',
        ...
        },
        {
          id: 'm-4',
          user_id: 'v4',
          title: 'Leña de Pino (Ramas caídas)',
          description: 'He cortado las ramas que cayeron en mi parcela ayer. Venir a buscar.',
          price: 'Gratis',
          category: 'jardineria',
