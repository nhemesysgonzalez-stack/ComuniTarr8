  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const realEventsExamples: Event[] = [
        {
          id: 'real-rallye-trepat-trophy',
          creator_id: 'admin',
          title: "🏆 Entrega Trofeos III Rallye Trepat",
          description: "Ceremonia de clausura y entrega de premios a los ganadores del Rallye de Tierra.",
          event_date: '2026-02-22',
          event_time: '13:00',
          location: 'Podio Central (Zona Meta)',
          category: 'Deporte',
          neighborhood: 'GENERAL',
          contact_info: 'Fed. Catalana Automobilisme',
          created_at: new Date().toISOString()
        },
        {
          id: 'real-mercat-antiguitats-evt',
          creator_id: 'admin',
          title: "🏺 Mercat de Antiguitats TGN",
          description: "Tradicional mercadillo de los domingos frente a la Catedral de Tarragona.",
          event_date: '2026-02-22',
          event_time: '09:00',
        ...
        {
          id: 'real-vermut-musical-evt',
          creator_id: 'admin',
          title: "🍹 Vermut Musical Serrallo",
          description: "Música en vivo y ambiente marinero para el mediodía del domingo.",
          event_date: '2026-02-22',
          event_time: '12:30',
          location: 'El Serrallo (Terrazas)',
          category: 'Ocio',
          neighborhood: 'EL SERRALLO',
          contact_info: 'Comerciantes del Serrallo',
          created_at: new Date().toISOString()
        }
      ];
