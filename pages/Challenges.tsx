    ...
    try {
      ...
      const mockChallenges: Challenge[] = [
        ...
        },
        {
          id: 'dom-22-ch-3',
          creator_id: 'v4',
          title: '📦 Solidaridad: Trastos Domingo Mañana',
          description: 'Mañana domingo es día de recogida. El reto es ayudar a al menos un vecino que no pueda bajar sus voluminosos a la calle. ¡Iniciativa vecinal pura!',
          neighborhood: 'CENTRE',
                ...
                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-3xl mb-4 text-center">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center">
                    {[
                      ...
                      { t: 'Paseo con Mayores', d: 'Grupo para pasear con vecinos del barrio que viven solos esta tarde de domingo al salir del trabajo.', c: '655666777' },
